...
const CACHE_NAME = 'digital-dth-shell-v2';
const CDN_SUPABASE = 'https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2';
const SHELL_URLS = [
  './', './index.html', './manifest.json', './icon-192.png', './icon-512.png', CDN_SUPABASE
];
...
self.addEventListener('fetch', function (event) {
  ...
  const isAppShellAsset = req.url === CDN_SUPABASE ||
    req.url.endsWith('/index.html') ||
    req.url.endsWith('/manifest.json') ||
    req.url.endsWith('/icon-192.png') ||
